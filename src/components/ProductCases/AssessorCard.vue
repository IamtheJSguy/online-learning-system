<template>
  <div class="inner-card mt-1">
    ...
    <p style="margin-left: 65px; margin-top: -38px; font-size: 13px">
      {{productCase.productCase.title}}
    </p>
    <div style="display: inline-flex">
        <button v-if="productCase.status === 'Claimed'" class="inner-card-button inner-card-button-active">
        Claimed
      </button>
      <button v-else class="inner-card-button" @click="claimProductCase">
        Claim
      </button>
