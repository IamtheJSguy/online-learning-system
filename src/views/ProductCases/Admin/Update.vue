          ...
          <div class="add-image-card">
            ...
            <div class="px-3" style="margin-top: 40px">
              <p class="" style="background-color: #19181f">
                <span
                  ><button type="button" class="test-item mr-2">+</button></span
                >
                ...
                >
                  ...
                  <div>
                    <input
                      ...
                      placeholder="Add Product Case title"
                      style="background-color: #3f3c49; font-size: 14px"
                    />
                    <textarea
                      class="introduction"
                    ...
                    >
                      <div class="part-container">
                        ...
                        <input
                          ...
                          v-model="
                            overview.parts[index].subParts[subIndex].title
                          "
                        />
                        <button
                          type="button"
                      ...
                      <b-form-select
                        v-model="overview.parts[index].subParts[subIndex].type"
                        class="select-assessor mb-1"
                      >
                      ...
                      <div
                        v-if="
                          overview.parts[index].subParts[subIndex].type ===
                          'Info'
                        "
                      >
                        <input
                          type="text"
                          style="width: 100%"
                          placeholder="Add Sub Part Text"
                          v-model="
                            overview.parts[index].subParts[subIndex].text
                          "
                        />
                      </div>
                      <div v-else>
                        <div
                          v-for="(question, questionIndex) in subPart.questions"
                          :key="questionIndex"
                        >
                          <div class="part-container part-input">
                            <input
                              ...
                              v-model="
                                overview.parts[index].subParts[subIndex]
                            ...
                            <button
                              ...
                              class="remove-part-button"
                              @click="
                                removeQuestion(index, subIndex, questionIndex)
                              "
                            >
                              -
                            </button>
                          ...
                          <div class="my-1" align="left">
                            <button
                              ...
                              style="
                                ...
                                border: none;
                              "
                              @click="addOption(index, subIndex, questionIndex)"
                            >
                              + Option
                            </button>
                          </div>
                        ...
                        <div align="left">
                          <button
                            ...
                            @click="addQuestion(index, subIndex)"
                          >
                            + Question
                          </button>
                        </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        <div
                          class="fx-con"
                          style="background-color: #19181f; width: 100%"
                        >
                          <img
        ...
        >
          ...
          >
            ...
            <input
              type="text"
              placeholder="1 day"
              style="color: #cccccc; width: 70%"
              v-model="overview.duration"
            />
          </div>
          <div
            class="row mt-2"
          ...
          >
            ...
            <input
              ...
              style="color: #cccccc; width: 70%"
              v-model="overview.deadline"
            />
          </div>
        </div>
      </div>
      <div style="text-align: -webkit-right">
        <button type="submit" class="level-button mr-5" style="color: #fff">
          Update Product Case
        </button>
      </div>
    </form>
...
export default {
  ...
  methods: {
    ...
    addQuestion(index, subIndex) {
      this.overview.parts[index].subParts[subIndex].questions.push({
        text: '',
        options: ['']
      })
    },
    removeOption(index, subIndex, questionIndex, optionIndex) {
      this.overview.parts[index].subParts[subIndex].questions[questionIndex].options = this.overview.parts[index].subParts[subIndex].questions[questionIndex].options.filter((option, key) => key !== optionIndex)
    },
    addOption(index, subIndex, questionIndex) {
      this.overview.parts[index].subParts[subIndex].questions[questionIndex].options.push('')
    },
    removeQuestion(index, subIndex, questionIndex) {
      this.overview.parts[index].subParts[subIndex].questions = this.overview.parts[index].subParts[subIndex].questions.filter((ques, key) => key !== questionIndex)
    },
    updateCourse(e) {
      e.preventDefault()
      this.$store.dispatch('updateProductCase', this.overview)
        .then(
          (response) => {
            if (response) {
              this.$router.push('/productcases')
            }
          }
        )
        .catch(
