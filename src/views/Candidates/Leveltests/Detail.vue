          ...
          <div style="" class="task">
            ...
            <div class="tab-content">
              ...
              >
                ...
                <ul>
                  <li
                    v-for="keyTakeAway in course.keyTakeAways"
                    :key="keyTakeAway"
              ...
              >
                <div
                  v-for="(part, index) in course.parts"
                  :key="index"
                  style="text-align: left"
                >
                  <div class="">
      ...
      <div class="col-lg-4 col-md-12 col-sm-12 basic-info-container">
        <div style="background-color: #19181f" class="px-2 py-1 w-100">
          ...
          >
            ...
            <p style="color: #cccccc">{{ course.duration }}</p>
          </div>
          <div
            class="row mt-2"
            style="
          ...
          >
            ...
            <p style="color: #cccccc">{{ course.language[0] }}</p>
          </div>
          <div
            class="row mt-2"
            style="
          ...
          >
            ...
            <p style="color: #cccccc">{{ course.deadline }}</p>
          </div>
          <button class="level-button mt-2" @click="buyCourse">Buy this Course</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    buyCourse() {
      this.$store.dispatch('buyCourse', this.$route.params.id)
        .then(
          (response) => {
